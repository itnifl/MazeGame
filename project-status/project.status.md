...
| -- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1  | Choose the scope and variability to model                                                                                                                             |   🟢   | Opponents and difficulties are the chosen variability focus. See `opponents-module/readme.md` and usage across the game.                                                                                                                                                                       |                                                                                                                                                                                                                                              |
...
| 4  | Provide at least three representative model instances                                                                                                                 |   🟢   | Multiple `.xmi` samples: opponents, difficulties, movements. Examples: `maze/src/main/resources/xmi/opponents/opponentModel.xmi`, `maze/src/main/resources/xmi/difficulties/difficulties.xmi`, `movements-module/src/main/resources/movements/*.xmi`.                                          |                                                                                                                                                                                                                                              |
...
| 12 | Include a README that explains how to build, run, and demonstrate the result                                                                                          |   🟢   | `readme.md` and `opponents-module/readme.md` include how to run and reference the model usage.                                                                                                                                                                                                 | Consider expanding with a short “demo steps” section that names the three sample models and what changes to expect.                                                                                                                          |
