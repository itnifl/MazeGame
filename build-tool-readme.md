...
## VS Code launch environment file

VS Code launch configurations load `.vscode/maze.launch.env`.
This file is generated by the make scripts after Java 21 discovery, it is not a hard coded machine path in docs.

Use one of these commands when Java changes on your machine:

```powershell
# JavaFX chain
.\make-javafx.ps1 write-launch-env
.\make-javafx.ps1 prepare-run

# libGDX chain
.\make-libgdx.ps1 write-launch-env
.\make-libgdx.ps1 prepare-run
```
...
# Generate .vscode/maze.launch.env only
.\make-javafx.ps1 write-launch-env

# Generate .vscode/maze.launch.env and prepare launch artifacts
.\make-javafx.ps1 prepare-run
...
# Generate .vscode/maze.launch.env and prepare runtime jars
.\make-libgdx.ps1 prepare-run
