...
/**
 * Self-contained grid maze generated with deterministic DFS backtracking.
 */
public final class SampleMaze implements MazeArena {
    ...
    @Override public float widthPx() { return cols * cellSize; }
    @Override public float heightPx() { return rows * cellSize; }

    @Override public List<WallSegment> walls() { return walls; }

    @Override public float startX() { return cellSize * 0.5f; }
    @Override public float startY() { return cellSize * 0.5f; }
    @Override public float goalX() { return (cols - 0.5f) * cellSize; }
    @Override public float goalY() { return (rows - 0.5f) * cellSize; }
