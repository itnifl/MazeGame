...
public class Point2D {
   ...
   public Point2D interpolate(Point2D var1, double var2) {
      if (var2 <= 0.0) {
         return this;
      } else {
         return var2 >= 1.0 ? var1 : new Point2D(this.getX() + (var1.getX() - this.getX()) * var2, this.getY() + (var1.getY() - this.getY()) * var2);
      }
   }
