...
public class Vector2D {
    ...
    */
     ...
     * 
     * The magnitude of a vector is a scalar value that represents the length or size of the vector. 
     * It is calculated as the square root of the sum of the squares of its components. 
     * In two-dimensional space, the magnitude of a vector with components (x, y) is given by the formula:
    ...
    /**
     * Normalizes this vector to a unit vector (magnitude of 1) and returns the result.
     * 
     * Normalizing a vector means scaling it to a length of 1 while preserving its direction. In other words, 
     * it involves dividing each component of the vector by the vector's magnitude (length), resulting in a unit vector. 
     ...
     * 
     * The dot product of two vectors is a scalar (single number) that represents the projection of one vector onto the other. 
     * Geometrically, it is the product of the magnitudes of the two vectors and the cosine of the angle between them. 
     * Mathematically, if two vectors are represented as A = (A1, A2) and B = (B1, B2), 
    ...
    /**
     * Calculates the magnitude of the cross product of this vector and the given vector.
     * 
     * The cross product of two vectors is a vector that is perpendicular to both vectors, and its magnitude 
     * is equal to the area of the parallelogram that they form. In two-dimensional space, the cross product 
     * of two vectors (x1, y1) and (x2, y2) is given by the formula x1 * y2 - y1 * x2.
     *
     * @param other the other vector to calculate the cross product with
     * @return the magnitude of the cross product of this vector and the given vector
     */
    ...
    // Returns the vertical distance of a vector, calculated by subtracting the Y coordinate of the starting point from the Y coordinate of the ending point
    public double getYVectorCoordinate() {
        return end.getY() - start.getY();
    }

    // Returns the horizontal distance of a vector, calculated by subtracting the X coordinate of the starting point from the X coordinate of the ending point
    ...
    // and 'p2q2' intersect.
    // Thank you Geeks for Geeks - https://www.geeksforgeeks.org/check-if-two-given-line-segments-intersect/
    public boolean doIntersect(Vector2D other, int xyOffset)
    {
        
        Point2D p1 = this.getStart(); Point2D p2 = other.getStart();
        Point2D q1 = this.getEnd(); Point2D q2 = other.getEnd(); 
