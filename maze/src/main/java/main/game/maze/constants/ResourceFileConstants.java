...
public class ResourceFileConstants {
    public final static String BackgroundMusic = "/main/game/maze/backgroundMusic.mp3";
    public final static String MenuMusic = "/main/game/maze/menuMusic.mp3";
    public final static String MenuSelectSound = "/main/game/maze/menuSelect.mp3";
    public final static String GameOverSound = "/main/game/maze/gameOver.mp3";
    public final static String HighscoreFilePath = "scores.txt";
