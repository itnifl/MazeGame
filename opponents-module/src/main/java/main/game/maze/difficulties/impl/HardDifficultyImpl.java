...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hard Difficulty</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link main.game.maze.difficulties.impl.HardDifficultyImpl#isInstantDeath <em>Instant Death</em>}</li>
 *   <li>{@link main.game.maze.difficulties.impl.HardDifficultyImpl#getEnemyMaxCount <em>Enemy Max Count</em>}</li>
 *   <li>{@link main.game.maze.difficulties.impl.HardDifficultyImpl#getMonstersMovementSpeedMultiplier <em>Monsters Movement Speed Multiplier</em>}</li>
 *   <li>{@link main.game.maze.difficulties.impl.HardDifficultyImpl#getMonstersDamageMultiplier <em>Monsters Damage Multiplier</em>}</li>
 *   <li>{@link main.game.maze.difficulties.impl.HardDifficultyImpl#getMaxThreat <em>Max Threat</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HardDifficultyImpl extends MinimalEObjectImpl.Container implements HardDifficulty {
	/**
	...
	protected EClass eStaticClass() {
		return DifficultiesPackage.Literals.HARD_DIFFICULTY;
	}
	...
	public void setInstantDeath(boolean newInstantDeath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifficultiesPackage.HARD_DIFFICULTY__INSTANT_DEATH, oldInstantDeath, instantDeath));
	}
	...
	public EList<EnemyMaxCount> getEnemyMaxCount() {
		if (enemyMaxCount == null) {
			enemyMaxCount = new EObjectResolvingEList<EnemyMaxCount>(EnemyMaxCount.class, this, DifficultiesPackage.HARD_DIFFICULTY__ENEMY_MAX_COUNT);
		}
	...
	public void setMonstersMovementSpeedMultiplier(double newMonstersMovementSpeedMultiplier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifficultiesPackage.HARD_DIFFICULTY__MONSTERS_MOVEMENT_SPEED_MULTIPLIER, oldMonstersMovementSpeedMultiplier, monstersMovementSpeedMultiplier));
	}
	...
	public void setMonstersDamageMultiplier(double newMonstersDamageMultiplier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifficultiesPackage.HARD_DIFFICULTY__MONSTERS_DAMAGE_MULTIPLIER, oldMonstersDamageMultiplier, monstersDamageMultiplier));
	}
	...
	public void setMaxThreat(int newMaxThreat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DifficultiesPackage.HARD_DIFFICULTY__MAX_THREAT, oldMaxThreat, maxThreat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DifficultiesPackage.HARD_DIFFICULTY__INSTANT_DEATH:
				return isInstantDeath();
			case DifficultiesPackage.HARD_DIFFICULTY__ENEMY_MAX_COUNT:
				return getEnemyMaxCount();
			case DifficultiesPackage.HARD_DIFFICULTY__MONSTERS_MOVEMENT_SPEED_MULTIPLIER:
				return getMonstersMovementSpeedMultiplier();
			case DifficultiesPackage.HARD_DIFFICULTY__MONSTERS_DAMAGE_MULTIPLIER:
				return getMonstersDamageMultiplier();
			case DifficultiesPackage.HARD_DIFFICULTY__MAX_THREAT:
				return getMaxThreat();
		}
